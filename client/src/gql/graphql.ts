...
export type BoxScoreFragmentFragment = { __typename?: 'BoxScore', winner: string, homeTeam: (
  ...
  ), homeStats: Array<{ __typename?: 'BoxStat', category: string, value: number, result?: string | null }>, homeLineup: Array<{ __typename?: 'BoxPlayer', gamePlayed: number, pointsBreakdown: Array<{ __typename?: 'Stat', category: string, value?: number | null }> } | null>, awayTeam: (
    { __typename?: 'Team' }
    & { ' $fragmentRefs'?: { 'TeamFragmentFragment': TeamFragmentFragment } }
  ), awayStats: Array<{ __typename?: 'BoxStat', category: string, value: number, result?: string | null }>, awayLineup: Array<{ __typename?: 'BoxPlayer', gamePlayed: number, pointsBreakdown: Array<{ __typename?: 'Stat', category: string, value?: number | null }> } | null> } & { ' $fragmentName'?: 'BoxScoreFragmentFragment' };
