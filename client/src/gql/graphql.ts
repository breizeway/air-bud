...
export type GetBoxScoresQuery = { __typename?: 'Query', getBoxScores: { __typename: 'GetBoxScoresResult', success: boolean, errors: Array<{ __typename?: 'Error', code: ErrorCodes, message: string } | null>, boxScores?: Array<{ __typename?: 'BoxScore', winner: string, homeTeam: { __typename?: 'Team', teamName: string }, homeStats: Array<{ __typename?: 'BoxStat', category: string, value: number, result?: string | null }>, awayTeam: { __typename?: 'Team', teamName: string }, awayStats: Array<{ __typename?: 'BoxStat', category: string, value: number, result?: string | null }> }> | null } };
